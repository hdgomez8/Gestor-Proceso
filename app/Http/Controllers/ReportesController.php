...
class ReportesController extends Controller
{
    ...
    public function buscarInterconsultas(Request $request)
    {
        ...
        if (strpos($pabellon, ',') !== false) {
            ...
            m.MPNomP AS NOMBRE_PABELLON,CASE WHEN MPNumC IS NULL THEN 'N/A' ELSE MPNumC END  CAMA,h.HISCKEY NUMERO_ID,h.HISTipDoc TIPO_ID,MPNOMC AS NOMBRE_DE_PACIENTE,
            H.HCtvIn1 CONSECUT_INGRESO,MENOMB CONTRATO,I.HISCSEC FOLIO,H.HisFHorAt FECHA_ORDEN,
